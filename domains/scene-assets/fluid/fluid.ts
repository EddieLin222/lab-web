...
class FluidSimulationDemoBase {
  ...
  protected async _generateParticles(regenerateAll = false) {
...
class FluidSimulationDemoPrecomputeRendering extends FluidSimulationDemoBase {
  ...
  constructor(scene: Scene, noFluidSimulation = true) {
    super(scene, noFluidSimulation);
...
export class Fluid {
  public static async CreateFluid(scene: Scene): Promise<Scene> {
